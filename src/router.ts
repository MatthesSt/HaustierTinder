...
export const routes = [
  ...
  { path: '/shelter', component: ShelterAdministration, icon: 'bi bi-house-add', active: "currentUser.value.role == 'admin'" },
  { path: '/profile-seeker', component: ProfileSeeker, icon: 'bi bi-person', active: 'true' },
  { path: '/profile-shelter', component: ProfileShelter, icon: 'bi bi-filetype-sh', active: "currentUser.value.role == 'tierheim'" },
];
